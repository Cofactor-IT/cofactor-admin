 ...
 */
export async function createPasswordResetToken(params: CreatePasswordResetTokenParams): Promise<string> {
  assertPasswordResetModelAvailable()
 ...
 */
export async function completePasswordReset(params: CompletePasswordResetParams): Promise<string | null> {
  assertPasswordResetModelAvailable()
